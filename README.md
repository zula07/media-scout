...
• ⚡️ Multi-Layered Query Engine: Unlike standard search engines, MediaScout executes optimized, multi-variant queries (e.g., "watch online", "full movie", "stream") to scrape the deepest available web indexes.
• 🎨 Cinema-Inspired UX: A stunning, dark-themed interface built with Tailwind CSS, offering a distraction-free, premium viewing experience.
